...
import {
    CheckCircle2, Bed, Wifi, Car, ShowerHead, 
    Sparkles, Wind, Users, Home
} from 'lucide-react';
...
// const heritageImages = Object.values(images2).map((img) => img.default);

import img from "../assets/heritage/img1.jpg"
...
import img9 from "../assets/heritage/img9.jpg"
import img10 from "../assets/heritage/img10.jpg"
// import img11 from "../assets/heritage/img12.jpg"
//import img12 from "../assets/heritage/img13.jpg"
...
const room = {
    ...
    inRoomComforts: {
        ...
        description: 'Enjoy a cozy stay with great décor and essential amenities. Comfortable rooms with good décor, AC/Air cooler, and a spacious common area to relax.',
        features: [
            'Comfortable rooms with good décor',
            'AC / Air cooler for optimal temperature',
    ...
    primaryAmenities: [
        { icon: <Home size={28} strokeWidth={1.5} />, text: 'Comfortable Rooms' },
        { icon: <Wind size={28} strokeWidth={1.5} />, text: 'AC / Air Cooler' },
        { icon: <ShowerHead size={28} strokeWidth={1.5} />, text: 'Hot Water' },
        { icon: <Wifi size={28} strokeWidth={1.5} />, text: 'Wi-Fi' },
        { icon: <Car size={28} strokeWidth={1.5} />, text: 'Parking Space' },
        { icon: <Users size={28} strokeWidth={1.5} />, text: 'Spacious Common Area' },
        { icon: <Sparkles size={28} strokeWidth={1.5} />, text: 'Clean Rooms' },
        { icon: <Bed size={28} strokeWidth={1.5} />, text: 'Good Décor' },
    ]
};
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-400 max-w-2xl mx-auto font-light">
                            We provide top-notch services and amenities to ensure your stay is comfortable and memorable.
                        </p>
                    </motion.div>
